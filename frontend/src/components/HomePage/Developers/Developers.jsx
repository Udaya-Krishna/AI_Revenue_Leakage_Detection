  ...
  const developers = [
    {
      ...
      specialization: "User interface and Data Science",
      image: GodwinImage,
      email: "godwin.wilfred@revenueguard.ai",
      bio: "Full-stack developer specializing in AI/ML solutions, data analytics, and secure application development using modern technologies.",
      skills: ["Machine Learning", "Data Science", "React", "GenAI", "Business Analytics", "Python","Cyber Security","Full Stack Development"],
      experience: "3+ years",
      projects: "10+",
      icon: Brain,
    ...
    },
    {
      ...
      bio: "Creative frontend engineer experienced in building scalable web applications using Python, expertise in LLM integration and deploying applications",
      skills: ["React", "GenAI", "Web Development", "GCP", "Large Language Models","Flask","MySQL","Python"],
      experience: "2+ years",
      projects: "8+",
      icon: Code,
    ...
    },
    {
      ...
      specialization: "Machine Learning  & Model Deployment",
      image: RagulImage,
      email: "ragul.kb@revenueguard.ai",
      bio: "Experienced in developing end-to-end data solutions using Python ecosystem tools, specializing in data cleaning, analysis, visualization, machine learning model training.",
      skills: ["Python", "Pandas", "Numpy", "Flask", "Data Cleaning", "Data Visualising"],
      experience: "2+ years",
      projects: "6+",
      icon: Database,
    ...
    },
    {
      ...
      title: "ML Engineer",
      subtitle: "Data Specialist",
      specialization: "Model Deployment & Data Processing",
      image: AshwinImage,
      email: "ashwin@revenueguard.ai", 
      bio: "Backend-focused developer with strong database expertise, specializing in data-intensive applications",
      skills: ["Java", "Python", "Flask", "Clickhouse", "SQL", "React"],
      experience: "3+ years",
      projects: "8+",
      icon: Shield,
    ...
    },
    {
      ...
      skills: ["Full-Stack", "REST APIs", "Javascript", "React", "Node.js", "MongoDB","Express.js"],
      experience: "3+ years", 
      projects: "9+",
      icon: Zap,
